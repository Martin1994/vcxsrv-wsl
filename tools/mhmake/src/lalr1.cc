...
# include <vector>
  ...
  /// A Bison parser.
  class ]b4_parser_class[ : public ]b4_parser_base_class_name[
  {
  public:
]b4_public_types_declare[
]b4_symbol_type_define[
    /// Build a parser object.
    ]b4_parser_class[ (]b4_parse_param_decl[ ]b4_parser_class_constructor_param[ );
    ...
    {
      return &yystack_[1].location.begin;
    }
...
#define YYRECOVERING()  (!!yyerrstatus_)
  ...
  /// Build a parser object.
  ]b4_parser_class::b4_parser_class[ (]b4_parse_param_decl[ ]b4_parser_class_constructor_param[) ]b4_parser_class_constructor_init[ ]m4_ifset([b4_parse_param], [
    :])[
#if ]b4_api_PREFIX[DEBUG
